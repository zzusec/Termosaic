...
自动“继续”的间隔、范围和 **激活 5h 窗口** 起始点都在自动“继续”子菜单里，更新仍留在顶层一行。切换到其他应用时隐藏画布、退出时隐藏 Terminal 两项始终开启。
...
- 可选 **激活 5h 窗口**：指定起始点（00:00、05:00、10:00、15:00、20:00）后，Termosaic 还会在每个 5 小时窗口开始时恢复一次，例如 05:00，之后 10:00、15:00…

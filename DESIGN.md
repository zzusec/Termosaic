...
- The top level stays short: canvas toggle, re-tile, version with update action, then 更多设置 and quit. Auto-continue, global shortcut, and preferences live under 更多设置.
